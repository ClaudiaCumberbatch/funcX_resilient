...
# )
# _MONITOR_EXECUTORS = [GlobusComputeEngine(
...
class Config(RepresentationMixin):
    ...
    def __init__(
        ...
        # executors: list = _MONITOR_EXECUTORS,
        # Connection info
        ...
        # Monitoring
        monitoring: MonitoringHub | None = None, #= _DEFAULT_MONITORING,
        # Misc info
        ...
        **kwargs,
        ...
        # Monitoring
        # print("initialize monitor", monitoring)
